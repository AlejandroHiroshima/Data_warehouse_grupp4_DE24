...
select 
    {{dbt_utils.generate_surrogate_key(['headline', 'description', 'description_html_formatted', 'employment_type', 'duration','salary_type', 'scope_of_work_min',
    'scope_of_work_max'])}} as job_details_id,
    headline,
    description,
